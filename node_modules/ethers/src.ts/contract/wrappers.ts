...
import { defineProperties, EventPayload } from "ethers/src.ts/utils";

import type { EventFragment, Interface, Result } from "ethers/src.ts/abi";
import type { Listener } from "ethers/src.ts/utils";
import type {
    Provider
} from "ethers/src.ts/providers";

import type { BaseContract } from "ethers/src.ts/contract/contract";
