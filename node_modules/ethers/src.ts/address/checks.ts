import { assert, assertArgument } from "ethers/src.ts/utils";

import { getAddress } from "ethers/src.ts/address/address";

import type { Addressable, AddressLike, NameResolver } from "ethers/src.ts/address";
