...
import { dnsEncode, namehash } from "ethers/src.ts/hash";
import {
...
import type { FunctionFragment } from "ethers/src.ts/abi";

import type { BytesLike } from "ethers/src.ts/utils";

import type { AbstractProvider, AbstractProviderPlugin } from "ethers/src.ts/providers/abstract-provider";
import type { EnsPlugin } from "ethers/src.ts/providers/plugins-network";
