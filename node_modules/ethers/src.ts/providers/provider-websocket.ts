...
import { WebSocket as _WebSocket } from "ethers/src.ts/providers/ws"; /*-browser*/

import { SocketProvider } from "ethers/src.ts/providers/provider-socket";

import type { JsonRpcApiProviderOptions } from "ethers/src.ts/providers/provider-jsonrpc";
